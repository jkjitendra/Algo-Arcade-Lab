...
export const topicLessons: Record<TopicKey, Lesson[]> = {
  ...
  strings: [
    ...
    { slug: "rabin-karp", title: "Rabin-Karp", duration: "20 min", description: "Pattern matching using rolling hash", hasContent: true },
    { slug: "z-algorithm", title: "Z-Algorithm", duration: "18 min", description: "Linear time pattern matching using Z-array", hasContent: true },
    { slug: "boyer-moore", title: "Boyer-Moore", duration: "22 min", description: "Efficient pattern matching with bad character rule", hasContent: true },
    { slug: "longest-palindrome", title: "Longest Palindrome", duration: "20 min", description: "Find longest palindromic substring", hasContent: true },
    { slug: "longest-common-substr", title: "Longest Common Substring", duration: "18 min", description: "Find longest common substring of two strings", hasContent: true },
    { slug: "string-rotation", title: "String Rotation", duration: "10 min", description: "Check if one string is rotation of another", hasContent: true },
    { slug: "remove-duplicates", title: "Remove Duplicates", duration: "12 min", description: "Remove duplicate characters from string", hasContent: true },
  ],
  ...
  sorting: [
    ...
    { slug: "cocktail-shaker", title: "Cocktail Shaker", duration: "15 min", description: "Bidirectional bubble sort variation", hasContent: true },
    { slug: "shell-sort", title: "Shell Sort", duration: "18 min", description: "Generalized insertion sort with gap sequences", hasContent: true },
    { slug: "cycle-sort", title: "Cycle Sort", duration: "15 min", description: "Optimal in terms of memory writes", hasContent: true },
    { slug: "heap-sort", title: "Heap Sort", duration: "20 min", description: "O(n log n) in-place sorting using heaps", hasContent: true },
    { slug: "tim-sort", title: "Tim Sort", duration: "25 min", description: "Hybrid stable sorting used in Python and Java", hasContent: true },
    { slug: "intro-sort", title: "Intro Sort", duration: "22 min", description: "Hybrid of quicksort, heapsort, and insertion sort", hasContent: true },
    { slug: "counting-sort", title: "Counting Sort", duration: "15 min", description: "Non-comparison O(n+k) sorting for integers", hasContent: true },
    { slug: "radix-sort", title: "Radix Sort", duration: "18 min", description: "Sort integers digit by digit", hasContent: true },
    { slug: "bucket-sort", title: "Bucket Sort", duration: "15 min", description: "Distribute elements into buckets then sort", hasContent: true },
    { slug: "pigeonhole-sort", title: "Pigeonhole Sort", duration: "12 min", description: "Sorting when key range is small", hasContent: true },
  ],
  ...
  searching: [
    ...
    { slug: "sentinel-linear-search", title: "Sentinel Linear Search", duration: "10 min", description: "Optimized linear search with sentinel", hasContent: true },
    { slug: "bidirectional-search", title: "Bidirectional Search", duration: "15 min", description: "Search from both ends simultaneously", hasContent: true },
    { slug: "search-insert-position", title: "Search Insert Position", duration: "12 min", description: "Find position to insert in sorted array", hasContent: true },
    { slug: "rotated-array-search", title: "Rotated Array Search", duration: "18 min", description: "Binary search in rotated sorted array", hasContent: true },
    { slug: "rotated-array-minimum", title: "Rotated Array Minimum", duration: "15 min", description: "Find minimum in rotated sorted array", hasContent: true },
    { slug: "jump-search", title: "Jump Search", duration: "12 min", description: "Block-based searching algorithm", hasContent: true },
    { slug: "interpolation-search", title: "Interpolation Search", duration: "15 min", description: "Improved binary search for uniform distribution", hasContent: true },
    { slug: "exponential-search", title: "Exponential Search", duration: "15 min", description: "Find range then binary search", hasContent: true },
    { slug: "fibonacci-search", title: "Fibonacci Search", duration: "18 min", description: "Divide array by Fibonacci numbers", hasContent: true },
    { slug: "ternary-search", title: "Ternary Search", duration: "15 min", description: "Find maximum/minimum in unimodal function", hasContent: true },
    { slug: "matrix-binary-search", title: "Matrix Binary Search", duration: "18 min", description: "Search in row and column sorted matrix", hasContent: true },
  ],
  ...
  stacks: [
    ...
    { slug: "postfix-evaluation", title: "Postfix Evaluation", duration: "15 min", description: "Evaluate postfix expressions using stack", hasContent: true },
    { slug: "prefix-evaluation", title: "Prefix Evaluation", duration: "15 min", description: "Evaluate prefix expressions using stack", hasContent: true },
    { slug: "infix-to-prefix", title: "Infix to Prefix", duration: "18 min", description: "Convert infix to prefix notation", hasContent: true },
    { slug: "next-smaller-element", title: "Next Smaller Element", duration: "15 min", description: "Find next smaller element for each position", hasContent: true },
    { slug: "stock-span", title: "Stock Span", duration: "18 min", description: "Calculate stock span using stack", hasContent: true },
    { slug: "largest-rectangle", title: "Largest Rectangle", duration: "22 min", description: "Largest rectangle in histogram", hasContent: true },
    { slug: "valid-stack-sequences", title: "Valid Stack Sequences", duration: "15 min", description: "Validate push and pop sequences", hasContent: true },
  ],
  ...
  queues: [
    ...
    { slug: "deque", title: "Deque", duration: "15 min", description: "Double-ended queue operations", hasContent: true },
    { slug: "queue-using-two-stacks", title: "Queue using Two Stacks", duration: "15 min", description: "Implement queue using two stacks", hasContent: true },
    { slug: "stack-using-two-queues", title: "Stack using Two Queues", duration: "15 min", description: "Implement stack using two queues", hasContent: true },
    { slug: "sliding-window-maximum", title: "Sliding Window Maximum", duration: "20 min", description: "Find maximum in each sliding window", hasContent: true },
    { slug: "first-non-repeating-char", title: "First Non-Repeating Char", duration: "15 min", description: "Find first non-repeating character in stream", hasContent: true },
    { slug: "generate-binary-numbers", title: "Generate Binary Numbers", duration: "12 min", description: "Generate binary numbers using queue", hasContent: true },
    { slug: "circular-tour", title: "Circular Tour", duration: "18 min", description: "Find starting point for circular tour", hasContent: true },
  ],
  ...
  "linked-lists": [
    ...
    { slug: "doubly-linked-list", title: "Doubly Linked List", duration: "20 min", description: "Bidirectional linked list operations", hasContent: true },
    { slug: "circular-linked-list", title: "Circular Linked List", duration: "15 min", description: "Linked list with tail pointing to head", hasContent: true },
    { slug: "circular-doubly-linked-list", title: "Circular Doubly Linked List", duration: "18 min", description: "Circular list with bidirectional links", hasContent: true },
    { slug: "merge-sorted-lists", title: "Merge Sorted Lists", duration: "15 min", description: "Merge two sorted linked lists", hasContent: true },
    { slug: "find-cycle-start", title: "Find Cycle Start", duration: "15 min", description: "Find starting node of cycle", hasContent: true },
    { slug: "remove-nth-from-end", title: "Remove N-th from End", duration: "12 min", description: "Remove nth node from end in one pass", hasContent: true },
    { slug: "palindrome-check", title: "Palindrome Check", duration: "15 min", description: "Check if linked list is palindrome", hasContent: true },
    { slug: "intersection-point", title: "Intersection Point", duration: "15 min", description: "Find intersection of two linked lists", hasContent: true },
    { slug: "rotate-list", title: "Rotate List", duration: "12 min", description: "Rotate linked list by k positions", hasContent: true },
    { slug: "flatten-multilevel-list", title: "Flatten Multilevel List", duration: "20 min", description: "Flatten a multilevel doubly linked list", hasContent: true },
  ],
